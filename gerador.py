...
def draw_certificate(doc, tipo, dados, bg_image_path):
    ...
    # 4. Body Text
    if tipo == 'aluno':
        html_text = f"Certificamos que o(a) estudante <b>{dados['nome_estudante']}</b>, com matrícula nº <b>{dados['matricula_estudante']}</b>, desenvolveu <b>{str(dados['horas_semanais']).zfill(2)}</b> horas semanais de atividades no <b>{dados['programa']}</b>, no período de <b>{dados['data_inicio']}</b> a <b>{dados['data_fim']}</b>, totalizando <b>{dados['horas_totais']}</b> horas, no <b>{dados['projeto']}</b>, sob a orientação do(a) Professor(a) <b>{dados['nome_orientador']}</b>, com matrícula nº <b>{dados['matricula_orientador']}</b>."
    else:
        html_text = f"Certificamos que o(a) Professor(a) <b>{dados['nome_orientador']}</b>, com matrícula nº <b>{dados['matricula_orientador']}</b>, orientou, no <b>{dados['programa']}</b>, o(a) estudante <b>{dados['nome_estudante']}</b>, com matrícula nº <b>{dados['matricula_estudante']}</b>, no período de <b>{dados['data_inicio']}</b> a <b>{dados['data_fim']}</b>, no <b>{dados['projeto']}</b>, com carga horária semanal de <b>{str(dados['horas_semanais']).zfill(2)}</b> horas, totalizando <b>{dados['horas_totais']}</b> horas."
